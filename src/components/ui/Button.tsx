...
/** Figma default action control — 32px total height (`421:4443`). */
const buttonDefaultSize =
  "box-border h-8 min-h-8 max-h-8 shrink-0 px-3 py-0 leading-[14px]";
...
const variants = {
  primary: `${buttonDefaultSize} border border-transparent bg-interactive-active text-text-on-primary hover:opacity-90 active:opacity-100 disabled:opacity-50`,
  tertiary: `h-8 min-h-8 max-h-8 leading-[14px] gap-1 px-1 py-0 text-text-secondary hover:bg-overlay-subtle disabled:!opacity-100 ${disabledLabel}`,
...
const secondarySizes = {
  default: `${buttonDefaultSize} border-interactive-secondary-pressed hover:text-text-primary active:text-text-primary`,
  small:
    "box-border h-7 min-h-7 max-h-7 shrink-0 border border-interactive-secondary-pressed px-[14px] py-0 leading-[14px] hover:text-text-primary active:text-text-primary",
} as const;
